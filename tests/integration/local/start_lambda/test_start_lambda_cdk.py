...
from tests.integration.local.start_lambda.test_start_lambda import TestWarmContainersBaseClass
...
class TestWarmContainers(TestWarmContainersBaseClass):
    template_path = "/testdata/start_api/cdk/template-cdk-warm-container.yaml"
