...
"""
    ...
    def test_cdk_function_url_basic(self):
        ...
        # Start service
        self.assertTrue(
            self.start_function_urls(self.template), "Failed to start Function URLs service with CDK template"
        )
    ...
    def test_cdk_function_url_with_cors(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Start service
            self.assertTrue(
                self.start_function_urls(template_path), "Failed to start Function URLs service with CDK CORS template"
            )
