...
class TestService_EventSerialization(TestCase):
    ...
    def test_calling_service_with_body_and_query_and_headers(self):
        ...
        expected = make_service_response(
            ...
            headers={"X-Test": "TestValue", "Content-Length": "16", "Content-Type": "application/json"},
        )

        response = requests.put(self.url + path, json=body, params={"key": "value"}, headers=headers)
...
class TestService_Binary(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.function = provider.Function(
            ...
            memory=256,
            timeout=5,
            handler="index.echoimagehandler",
            codeuri=cls.code_uri,
            environment=None,
            rolearn=None,
            layers=[],
