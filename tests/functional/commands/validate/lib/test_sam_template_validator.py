...
class TestValidate(TestCase):
	...
	("tests/functional/commands/validate/lib/models/application_preparing_state.yaml")
	("tests/functional/commands/validate/lib/models/application_with_intrinsics.yaml")
	("tests/functional/commands/validate/lib/models/basic_application.yaml")
	...
	("tests/functional/commands/validate/lib/models/existing_event_logical_id.yaml")
	("tests/functional/commands/validate/lib/models/existing_permission_logical_id.yaml")
	("tests/functional/commands/validate/lib/models/existing_role_logical_id.yaml")
