...
class TestSamTemplateValidator(TestCase):
    ...
    def test_DefinitionBody_gets_replaced_in_api(self, yaml_mock, path_mock):
        template = {
            ...
            "Transform": "AWS::Serverless-2016-10-31",
            "Resources": {
                "Function": {"Properties": {"Handler": "index.handler"}},
                "ServerlessApi": {
                    "Type": "AWS::Serverless::Api",
                    "Properties": {
                        "StageName": "Prod",
...
paths:
    ...
    @patch("pathlib.Path.is_file")
    @patch("samcli.commands.validate.lib.sam_template_validator.parse_yaml_file")
    def test_DefinitionBody_not_replaced_if_not_string(self, yaml_mock, path_mock):
        template = {
            "AWSTemplateFormatVersion": "2010-09-09",
            "Transform": "AWS::Serverless-2016-10-31",
            "Resources": {
                    ...
                    "Properties": {
                        ...
                        "DefinitionBody": {
                            "Fn::Transform": {
                                "Name": "AWS::Include",
                                "Parameters": {
                                    "Location": {"Fn::Join": ["", ["s3://", {"Ref": "ArtifactsPath"}, "/openapi.yaml"]]}
                                },
                            }
                        },
                    },
