...
class TestInvokeFunctionUrlsCommand(TestCase):
    ...
    def test_custom_formatter_context(self):
        ...
        self.assertEqual(
            InvokeFunctionUrlsCommand.CustomFormatterContext.formatter_class, 
            InvokeFunctionUrlsCommandHelpTextFormatter
        )
    ...
    def test_format_options(self):
        ...
        with patch.object(command, 'format_description') as format_desc_mock:
            with patch.object(command, 'get_params') as get_params_mock:
                with patch('samcli.commands.local.start_function_urls.core.command.CoreCommand._format_options') as format_options_mock:
