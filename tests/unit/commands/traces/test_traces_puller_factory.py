...
class TestGenerateTracePuller(TestCase):
    ...
    @patch("samcli.commands.traces.traces_puller_factory.generate_console_consumer")
    @patch("samcli.commands.traces.traces_puller_factory.generate_file_consumer")
    ...
    def test_generate_trace_puller(
        ...
        self.assertEqual(given_xray_trace_puller, actual_puller)
    ...
    def test_generate_file_consumer(self, patched_file_consumer, patched_trace_file_mapper, patched_consumer_decorator):
        ...
        actual_consumer = generate_file_consumer(output_dir)
    ...
    def test_generate_console_consumer(
        ...
        actual_consumer = generate_console_consumer()
        self.assertEqual(given_consumer, actual_consumer)
