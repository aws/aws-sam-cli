...
from samcli.commands.remote.callback.fail.cli import cli, do_cli


class TestRemoteCallbackFailCli(unittest.TestCase):
    def setUp(self):
    ...
    def test_cli_help(self):
        ...
        self.assertIn("Send a callback failure", result.output)

    @patch("samcli.commands.remote.callback.fail.cli.do_cli")
    ...
    @patch("samcli.commands.remote.callback.fail.cli.get_boto_client_provider_from_session_with_config")
    @patch("samcli.commands.remote.callback.fail.cli.Session")
    @patch("samcli.commands.remote.callback.fail.cli.DurableFunctionsClient")
    @patch("samcli.commands.remote.callback.fail.cli.click.echo")
    def test_do_cli_success(self, mock_echo, mock_durable_client_class, mock_session_class, mock_get_client_provider):
        ...
        mock_durable_client.send_callback_failure.return_value = {}

        do_cli(mock_ctx, "test-id", None, (), None, None)
        ...
        mock_durable_client.send_callback_failure.assert_called_once()
