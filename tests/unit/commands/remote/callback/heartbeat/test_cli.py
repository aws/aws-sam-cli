...
from samcli.commands.remote.callback.heartbeat.cli import cli, do_cli


class TestRemoteCallbackHeartbeatCli(unittest.TestCase):
    def setUp(self):
    ...
    def test_cli_help(self):
        ...
        self.assertIn("Send a callback heartbeat", result.output)

    @patch("samcli.commands.remote.callback.heartbeat.cli.do_cli")
    ...
    @patch("samcli.commands.remote.callback.heartbeat.cli.get_boto_client_provider_from_session_with_config")
    @patch("samcli.commands.remote.callback.heartbeat.cli.Session")
    @patch("samcli.commands.remote.callback.heartbeat.cli.DurableFunctionsClient")
    @patch("samcli.commands.remote.callback.heartbeat.cli.click.echo")
    def test_do_cli_success(self, mock_echo, mock_durable_client_class, mock_session_class, mock_get_client_provider):
        ...
        mock_durable_client.send_callback_heartbeat.return_value = {}

        do_cli(mock_ctx, "test-id")
        ...
        mock_durable_client.send_callback_heartbeat.assert_called_once()
