...
TEMPLATE_MOCK = {"Resources": {"resource": {"Type": "resource", "Properties": {"key": "value"}}}}
...
class TestDeleteContext(TestCase):
    ...
    @patch.object(CfnUtils, "get_stack_template", MagicMock(return_value=({"TemplateBody": TEMPLATE_MOCK})))
