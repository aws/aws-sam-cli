...
class TestConversionFunctions(TestCase):
    def test_function_build_definition_to_toml_table(self):
        build_definition = FunctionBuildDefinition(
            "runtime", "codeuri", ZIP, X86_64, {"key": "value"}, "source_md5", env_vars={"env_vars": "value1"}
        )
    ...
    def test_layer_build_definition_to_toml_table(self):
        build_definition = LayerBuildDefinition(
            "name", "codeuri", "method", "runtime", ARM64, env_vars={"env_vars": "value"}
        )
...
class TestBuildDefinition(TestCase):
    def test_single_function_should_return_function_and_handler_name(self):
        build_definition = FunctionBuildDefinition(
            "runtime", "codeuri", ZIP, X86_64, "metadata", "source_md5", {"env_vars": "value"}
        )
        build_definition.add_function(generate_function())
    ...
    def test_same_runtime_codeuri_metadata_should_reflect_as_same_object(self):
        build_definition1 = FunctionBuildDefinition("runtime", "codeuri", ZIP, ARM64, {"key": "value"}, "source_md5")
        build_definition2 = FunctionBuildDefinition("runtime", "codeuri", ZIP, ARM64, {"key": "value"}, "source_md5")
    ...
    def test_different_runtime_codeuri_metadata_should_not_reflect_as_same_object(
        ...
        build_definition1 = FunctionBuildDefinition(runtime1, codeuri1, ZIP, ARM64, metadata1, source_md5_1)
        build_definition2 = FunctionBuildDefinition(runtime2, codeuri2, ZIP, ARM64, metadata2, source_md5_2)
    ...
    def test_different_env_vars_should_not_reflect_as_same_object(self):
        build_definition1 = FunctionBuildDefinition(
            "runtime", "codeuri", ZIP, ARM64, {"key": "value"}, "source_md5", {"env_vars": "value1"}
        )
        build_definition2 = FunctionBuildDefinition(
            "runtime", "codeuri", ZIP, ARM64, {"key": "value"}, "source_md5", {"env_vars": "value2"}
        )

        self.assertNotEqual(build_definition1, build_definition2)

    def test_euqality_with_another_object(self):
        build_definition = FunctionBuildDefinition("runtime", "codeuri", ZIP, X86_64, None, "source_md5")
        self.assertNotEqual(build_definition, {})

    def test_str_representation(self):
        build_definition = FunctionBuildDefinition("runtime", "codeuri", ZIP, ARM64, None, "source_md5")
        self.assertEqual(
            str(build_definition),
            f"BuildDefinition(runtime, codeuri, Zip, arm64, source_md5, {build_definition.uuid}, {{}}, {{}}, [])",
        )
