...
from samcli.lib.test.test_executors import (
    TestExecutionInfo,
    BotoActionExecutor,
    TestExecutor,
...
class TestTestExecutionInfo(TestCase):
    def test_execution_info_payload(self):
        ...
        test_execution_info = TestExecutionInfo(given_payload, None)
    ...
    def test_execution_info_payload_file(self):
        ...
        test_execution_info = TestExecutionInfo(None, given_payload_file)
...
class TestTestExecutor(TestCase):
    def setUp(self) -> None:
        ...
        self.mock_request_mappers = [Mock(), Mock(), Mock()]
        self.mock_response_mappers = [Mock(), Mock(), Mock()]
    ...
    def test_execution_failure(self):
        ...
        given_result_execution_info = TestExecutionInfo(given_payload, None)
