...
#         context_mock.command_params.get.side_effect = _make_ctx_params_side_effect_func(params)
#
#         project_mock = Mock()
#         iac_options_validation(project=project_mock, ctx=context_mock, require_stack=False)
#
...
#
#         project_mock = Mock()
#         iac_options_validation(project=project_mock, ctx=context_mock, require_stack=True)
#
#     @patch("samcli.commands._utils.iac_validations.click")
...
#         context_mock = MagicMock()
#         context_mock.command_params.get.side_effect = _make_ctx_params_side_effect_func(params)
#         context_mock.command_path_without_sam = "deploy"
