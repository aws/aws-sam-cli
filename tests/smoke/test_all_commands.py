...
# Calculate split points for dividing into quarters
...
if SMOKE_TEST_SUBSET == "first-quarter":
    TEMPLATE_FILE_NAMES = ALL_TEMPLATE_FILE_NAMES[:q1]
elif SMOKE_TEST_SUBSET == "second-quarter":
    TEMPLATE_FILE_NAMES = ALL_TEMPLATE_FILE_NAMES[q1:q2]
elif SMOKE_TEST_SUBSET == "third-quarter":
