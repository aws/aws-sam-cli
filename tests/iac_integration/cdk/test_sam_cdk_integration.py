...
class TestSamCdkIntegration(TestCase):
    ...
    @parameterized.expand(
        [
            ...
            ("/restapis/normal/functionJavaRuntime", "Hello World from function construct with java runtime 7"),
            ("/restapis/normal/bundledFunctionJavaRuntime", "Hello World from java bundled function construct runtime 7"),
            ("/restapis/normal/preBuiltFunctionJavaRuntime", "Hello World from java pre built function 7"),
