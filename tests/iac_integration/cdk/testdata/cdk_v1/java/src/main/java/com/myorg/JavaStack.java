...
import software.amazon.awscdk.services.lambda.go.GoFunction;
...
import software.amazon.awscdk.services.lambda.python.PythonLayerVersion;
...
public class JavaStack extends Stack {
    ...
    public JavaStack(final Construct scope, final String id, final StackProps props) {
        ...
        NodejsFunction nodejsFunction = NodejsFunction.Builder.create(this, "NodejsFunction")
                .entry("../../src/nodejs/NodeJsFunctionConstruct/handler.rb")
        ...
        GoFunction goFunction = GoFunction.Builder.create(this, "GoFunction")
                ...
                .bundling(software.amazon.awscdk.services.lambda.go.BundlingOptions.builder()
