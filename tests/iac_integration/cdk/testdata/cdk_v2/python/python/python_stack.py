...
from aws_cdk import Stack, Duration, BundlingOptions, aws_lambda as lambda1, aws_apigateway as apigw, aws_logs as logs
...
from aws_cdk.aws_lambda_go_alpha import GoFunction, BundlingOptions as GoBundlingOptions
