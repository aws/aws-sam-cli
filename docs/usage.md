...
In your integration test, you can use AWS SDK to invoke your Lambda
...
Note: localRoot is set based on what the CodeUri points at
...
Now that we have both dependencies and ptvsd enabled within our code we
