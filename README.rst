...
the environment variable ``SAM_DEBUGGER_ARGUMENTS``. This will pass a string
...
.. code:: bash
   ...
   $ SAM_DEBUGGER_ARGUMENTS="-m ikpdb --ikpdb-port=5858 --ikpdb-working-directory=/var/task/ --ikpdb-client-working-directory=/myApp --ikpdb-address=0.0.0.0" echo {} | sam local invoke -d 5858 myFunction
