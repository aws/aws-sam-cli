...
from samcli.lib.telemetry.metric import MetricName, track_metric
...
class LambdaRuntime:
    ...
    def invoke(
        ...
        try:
            # Track runtime
            track_metric(
                # NOTE: "runtimes" attr has to be an array
                MetricName.runtimeMetric,
                top_level_attrs={"runtimes": [function_config.runtime]},
            )
