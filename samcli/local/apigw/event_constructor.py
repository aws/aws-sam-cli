...
class EventConstructor:
    @staticmethod
    def v1_event(flask_request, port, binary_types, stage_name=None, stage_variables=None, operation_name=None) -> str:
        """
        ...
        is_base_64 = EventConstructor._should_base64_encode(binary_types, request_mimetype)
        ...
        query_string_dict, multi_value_query_string_dict = EventConstructor._query_string_params(flask_request)
        ...
        headers_dict, multi_value_headers_dict = EventConstructor._event_headers(flask_request, port)
    ...
    def v2_event_http(
        ...
        query_string_dict = EventConstructor._query_string_params_v_2_0(flask_request)

        cookies = EventConstructor._event_http_cookies(flask_request)
        headers = EventConstructor._event_http_headers(flask_request, port)
