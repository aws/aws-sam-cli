...
def _sync_state_to_toml_document(sync_state: SyncState) -> TOMLDocument:
    ...
    toml_document.add(SYNC_STATE, sync_state_toml_table)

    return toml_document


def _toml_document_to_sync_state(toml_document: TOMLDocument) -> Optional[SyncState]:
    ...
    def _read(self) -> None:
        try:
            with open(self._file_path) as file:
                toml_document = tomlkit.loads(file.read())
