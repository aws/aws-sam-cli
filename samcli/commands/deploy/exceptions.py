...
class ChangeEmptyError(UserException):
    def __init__(self, stack_name):  # type: ignore[no-untyped-def]
        self.stack_name = stack_name
        message_fmt = "No changes to deploy. Stack {stack_name} is up to date"
        super().__init__(message=message_fmt.format(stack_name=self.stack_name))  # type: ignore[no-untyped-call]
...
class ChangeSetError(UserException):
    def __init__(self, stack_name, msg):  # type: ignore[no-untyped-def]
        ...
        super().__init__(message=message_fmt.format(stack_name=self.stack_name, msg=self.msg))  # type: ignore[no-untyped-call]
...
class DeployFailedError(UserException):
    def __init__(self, stack_name, msg):  # type: ignore[no-untyped-def]
        ...
        super().__init__(message=message_fmt.format(stack_name=self.stack_name, msg=msg))  # type: ignore[no-untyped-call]


class GuidedDeployFailedError(UserException):
    def __init__(self, msg):  # type: ignore[no-untyped-def]
        self.msg = msg
        super().__init__(message=msg)  # type: ignore[no-untyped-call]
...
class DeployBucketInDifferentRegionError(UserException):
    def __init__(self, msg):  # type: ignore[no-untyped-def]
        ...
        super().__init__(message=message_fmt.format(msg=self.msg))  # type: ignore[no-untyped-call]
...
class DeployStackStatusMissingError(UserException):
    def __init__(self, stack_name):  # type: ignore[no-untyped-def]
        ...
        super().__init__(message=message_fmt.format(msg=stack_name))  # type: ignore[no-untyped-call]
