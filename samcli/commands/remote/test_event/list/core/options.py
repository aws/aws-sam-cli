"""
List Remote Test Events Command Options related Datastructures for formatting.
"""
...
ALL_OPTIONS: List[str] = (
    INFRASTRUCTURE_OPTION_NAMES + AWS_CREDENTIAL_OPTION_NAMES + CONFIGURATION_OPTION_NAMES + ALL_COMMON_OPTIONS
)
