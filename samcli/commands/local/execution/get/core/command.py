"""
Get Local Execution Command Class.
"""

from click import Context, style

from samcli.cli.row_modifiers import RowDefinition, ShowcaseRowModifier
from samcli.commands.common.execution.get.options import COMMON_EXECUTION_GET_FORMATTING_OPTIONS_INFO
...
class LocalExecutionGetCommand(LocalExecutionBaseCommand):
    def get_formatting_options(self):
        return COMMON_EXECUTION_GET_FORMATTING_OPTIONS_INFO
