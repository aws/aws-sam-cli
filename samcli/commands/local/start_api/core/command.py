...
from samcli.commands.local.start_api.core.options import ALL_OPTIONS, OPTIONS_INFO
        ...
        with formatter.indented_section(name="Examples", extra_indents=1):
            with formatter.indented_section(name="Setup", extra_indents=1):
                with formatter.indented_section(
                    name="Start the local lambda with Amazon API Gateway endpoint:", extra_indents=0
                ):
            ...
            with formatter.indented_section(name="Invoke local Lambda endpoint", extra_indents=1):
                with formatter.indented_section(name="Invoke Lambda function locally using curl:", extra_indents=0):
                    formatter.write_text_rows(
                        [
                            RowDefinition(
