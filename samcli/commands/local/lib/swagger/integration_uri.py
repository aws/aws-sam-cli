...
class LambdaUri:
    ...
    # Extracts a more general Lambda Function ARN if the search with above regex failed
    # Example:
    #   arn:aws:apigateway:us-east-1:lambda:path/2015-03-31/functions/${MyCoolFunction.Alias}/invocations  # NOQA
    _REGEX_GET_FUNCTION_ARN_ALT = r"/functions/([^/]+)/invocations"
    ...
    def _get_function_arn(uri_data):
        ...
        matches = re.search(LambdaUri._REGEX_GET_FUNCTION_ARN_ALT, uri_data)
        if matches:
