...
\b
e.g. sam destroy -stack-name sam-app --retain-resources LOGICAL_ID_1 --retain-resources LOGICAL_ID_2
     --retain-resources LOGICAL_ID_3 --role-arn <SOME ROLE ARN> --wait --wait-time 500
"""
