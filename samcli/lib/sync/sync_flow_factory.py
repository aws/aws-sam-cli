    ...
    def load_physical_id_mapping(self) -> None:
        ...
        self._physical_id_mapping = get_physical_id_mapping(
            get_boto_resource_provider_with_config(
                region=self._deploy_context.region if self._deploy_context.region else None,
                profile=self._deploy_context.profile if self._deploy_context.profile else None,
            ),
