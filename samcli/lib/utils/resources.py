...
RESOURCES_WITH_LOCAL_PATHS = {
    ...
    AWS_APPSYNC_RESOLVER: ["CodeS3Location", "RequestMappingTemplateS3Location", "ResponseMappingTemplateS3Location"],
    AWS_APPSYNC_FUNCTIONCONFIGURATION: ["CodeS3Location", "RequestMappingTemplateS3Location", "ResponseMappingTemplateS3Location"],
