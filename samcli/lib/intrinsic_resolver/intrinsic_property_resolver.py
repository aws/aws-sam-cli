...
class IntrinsicResolver:
    ...
    def __init__(self, template, symbol_resolver):  # type: ignore[no-untyped-def]
        """
        ...
        self._outputs = None
        self.init_template(template)  # type: ignore[no-untyped-call]

        self._symbol_resolver = symbol_resolver

        self.intrinsic_key_function_map = self.default_intrinsic_function_map()  # type: ignore[no-untyped-call]
        self.conditional_key_function_map = self.default_conditional_key_map()  # type: ignore[no-untyped-call]

    def init_template(self, template):  # type: ignore[no-untyped-def]
    ...
    def default_intrinsic_function_map(self):  # type: ignore[no-untyped-def]
        """
    ...
    def default_conditional_key_map(self):  # type: ignore[no-untyped-def]
        """
    ...
    def set_intrinsic_key_function_map(self, function_map):  # type: ignore[no-untyped-def]
        """
    ...
    def set_conditional_function_map(self, function_map):  # type: ignore[no-untyped-def]
        """
        Sets the mapping from
            Conditional Intrinsic Function Key -> Conditional Intrinsic Resolver.
        The intrinsic_resolver function has the format lambda intrinsic: some_retun_value
    ...
    def intrinsic_property_resolver(self, intrinsic, ignore_errors, parent_function="template"):  # type: ignore[no-untyped-def]
        """
        ...
        if isinstance(intrinsic, list):
            return [self.intrinsic_property_resolver(item, ignore_errors) for item in intrinsic]  # type: ignore[no-untyped-call]
        ...
        for key, val in intrinsic.items():
            try:
                sanitized_key = self.intrinsic_property_resolver(key, ignore_errors, parent_function=parent_function)  # type: ignore[no-untyped-call]
                sanitized_val = self.intrinsic_property_resolver(val, ignore_errors, parent_function=parent_function)  # type: ignore[no-untyped-call]
                verify_intrinsic_type_str(  # type: ignore[no-untyped-call]
                    sanitized_key,
    ...
    def resolve_template(self, ignore_errors=False):  # type: ignore[no-untyped-def]
        """
        ...
        if self._resources:
            processed_template["Resources"] = self.resolve_attribute(self._resources, ignore_errors)  # type: ignore[no-untyped-call, index]
        if self._outputs:
            processed_template["Outputs"] = self.resolve_attribute(self._outputs, ignore_errors)  # type: ignore[no-untyped-call, index]

        return processed_template

    def resolve_attribute(self, cloud_formation_property, ignore_errors=False):  # type: ignore[no-untyped-def]
        """
        ...
        for key, val in cloud_formation_property.items():
            ...
            try:
                processed_resource = self.intrinsic_property_resolver(val, ignore_errors, parent_function=processed_key)  # type: ignore[no-untyped-call]
    ...
    def handle_fn_join(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        ...
        """
        arguments = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            intrinsic_value, ignore_errors, parent_function=IntrinsicResolver.FN_JOIN
        )

        verify_intrinsic_type_list(arguments, IntrinsicResolver.FN_JOIN)  # type: ignore[no-untyped-call]

        delimiter = arguments[0]

        verify_intrinsic_type_str(delimiter, IntrinsicResolver.FN_JOIN, position_in_list="first")  # type: ignore[no-untyped-call]

        value_list = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            arguments[1], ignore_errors, parent_function=IntrinsicResolver.FN_JOIN
        )

        verify_intrinsic_type_list(  # type: ignore[no-untyped-call]
            value_list,
        ...
        sanitized_value_list = [
            self.intrinsic_property_resolver(item, ignore_errors, parent_function=IntrinsicResolver.FN_JOIN)  # type: ignore[no-untyped-call]
            for item in value_list
        ]
        verify_all_list_intrinsic_type(  # type: ignore[no-untyped-call]
    ...
    def handle_fn_split(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        ...
        verify_intrinsic_type_list(arguments, IntrinsicResolver.FN_SPLIT)  # type: ignore[no-untyped-call]

        delimiter = arguments[0]

        verify_intrinsic_type_str(delimiter, IntrinsicResolver.FN_SPLIT, position_in_list="first")  # type: ignore[no-untyped-call]

        source_string = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            arguments[1], ignore_errors, parent_function=IntrinsicResolver.FN_SPLIT
        )

        verify_intrinsic_type_str(source_string, IntrinsicResolver.FN_SPLIT, position_in_list="second")  # type: ignore[no-untyped-call]

        return source_string.split(delimiter)

    def handle_fn_base64(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        ...
        A string with the resolved attributes
        """
        data = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            intrinsic_value, ignore_errors, parent_function=IntrinsicResolver.FN_BASE64
        )

        verify_intrinsic_type_str(data, IntrinsicResolver.FN_BASE64)  # type: ignore[no-untyped-call]
        # Encoding then decoding is required to return a string of the data
        return base64.b64encode(data.encode()).decode()

    def handle_fn_select(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        ...
        verify_intrinsic_type_list(arguments, IntrinsicResolver.FN_SELECT)  # type: ignore[no-untyped-call]

        index = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            arguments[0], ignore_errors, parent_function=IntrinsicResolver.FN_SELECT
        )

        verify_intrinsic_type_int(index, IntrinsicResolver.FN_SELECT)  # type: ignore[no-untyped-call]

        list_of_objects = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            arguments[1], ignore_errors, parent_function=IntrinsicResolver.FN_SELECT
        )
        verify_intrinsic_type_list(list_of_objects, IntrinsicResolver.FN_SELECT)  # type: ignore[no-untyped-call]

        sanitized_objects = [
            self.intrinsic_property_resolver(item, ignore_errors, parent_function=IntrinsicResolver.FN_SELECT)  # type: ignore[no-untyped-call]
            for item in list_of_objects
        ]

        verify_in_bounds(index=index, objects=sanitized_objects, property_type=IntrinsicResolver.FN_SELECT)  # type: ignore[no-untyped-call]

        return sanitized_objects[index]

    def handle_find_in_map(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        ...
        verify_intrinsic_type_list(arguments, IntrinsicResolver.FN_FIND_IN_MAP)  # type: ignore[no-untyped-call]

        verify_number_arguments(arguments, num=3, property_type=IntrinsicResolver.FN_FIND_IN_MAP)  # type: ignore[no-untyped-call]

        map_name = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            arguments[0], ignore_errors, parent_function=IntrinsicResolver.FN_FIND_IN_MAP
        )
        top_level_key = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            arguments[1], ignore_errors, parent_function=IntrinsicResolver.FN_FIND_IN_MAP
        )
        second_level_key = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            arguments[2], ignore_errors, parent_function=IntrinsicResolver.FN_FIND_IN_MAP
        )

        verify_intrinsic_type_str(map_name, IntrinsicResolver.FN_FIND_IN_MAP, position_in_list="first")  # type: ignore[no-untyped-call]
        verify_intrinsic_type_str(top_level_key, IntrinsicResolver.FN_FIND_IN_MAP, position_in_list="second")  # type: ignore[no-untyped-call]
        verify_intrinsic_type_str(second_level_key, IntrinsicResolver.FN_FIND_IN_MAP, position_in_list="third")  # type: ignore[no-untyped-call]

        map_value = self._mapping.get(map_name)  # type: ignore[union-attr]
        verify_intrinsic_type_dict(  # type: ignore[no-untyped-call]
            map_value,
    ...
    def handle_fn_get_azs(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        { "Fn::GetAZs" : "" }
        ...
        A string with the resolved attributes
        """
        intrinsic_value = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            intrinsic_value, ignore_errors, parent_function=IntrinsicResolver.FN_GET_AZS
        )
        verify_intrinsic_type_str(intrinsic_value, IntrinsicResolver.FN_GET_AZS)  # type: ignore[no-untyped-call]
    ...
    def handle_fn_transform(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        ...
        name = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
        ...
        location = self.intrinsic_property_resolver(parameters.get("Location"), ignore_errors)  # type: ignore[no-untyped-call]
        location_data = get_template_data(location)  # type: ignore[no-untyped-call]

        return location_data

    @staticmethod
    def handle_fn_import_value(intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
    ...
    def handle_fn_getatt(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        ...
        verify_intrinsic_type_list(arguments, IntrinsicResolver.FN_GET_ATT)  # type: ignore[no-untyped-call]
        verify_number_arguments(arguments, IntrinsicResolver.FN_GET_ATT, num=2)  # type: ignore[no-untyped-call]

        logical_id = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            arguments[0], ignore_errors, parent_function=IntrinsicResolver.FN_GET_ATT
        )
        resource_type = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            arguments[1], ignore_errors, parent_function=IntrinsicResolver.FN_GET_ATT
        )

        verify_intrinsic_type_str(logical_id, IntrinsicResolver.FN_GET_ATT)  # type: ignore[no-untyped-call]
        verify_intrinsic_type_str(resource_type, IntrinsicResolver.FN_GET_ATT)  # type: ignore[no-untyped-call]

        return self._symbol_resolver.resolve_symbols(logical_id, resource_type)

    def handle_fn_ref(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        {"Ref": "Logical ID"}
        ...
        verify_intrinsic_type_str(arguments, IntrinsicResolver.REF)  # type: ignore[no-untyped-call]

        return self._symbol_resolver.resolve_symbols(arguments, IntrinsicResolver.REF)

    def handle_fn_sub(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        ...
        def resolve_sub_attribute(intrinsic_item, symbol_resolver):  # type: ignore[no-untyped-def]
        ...
        verify_number_arguments(intrinsic_value, IntrinsicResolver.FN_SUB, num=2)  # type: ignore[no-untyped-call]

        sub_str = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            intrinsic_value[0], ignore_errors, parent_function=IntrinsicResolver.FN_SUB
        )
        verify_intrinsic_type_str(sub_str, IntrinsicResolver.FN_SUB, position_in_list="first")  # type: ignore[no-untyped-call]

        variables = intrinsic_value[1]
        verify_intrinsic_type_dict(variables, IntrinsicResolver.FN_SUB, position_in_list="second")  # type: ignore[no-untyped-call]

        sanitized_variables = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
        ...
        for sub_item in subable_props:
            ...
            result = resolve_sub_attribute(sanitized_item, self._symbol_resolver)  # type: ignore[no-untyped-call]
            sub_str = re.sub(pattern=r"\$\{" + sub_item + r"\}", string=sub_str, repl=str(result))
        return sub_str

    def handle_fn_if(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        ...
        verify_intrinsic_type_list(arguments, IntrinsicResolver.FN_IF)  # type: ignore[no-untyped-call]
        verify_number_arguments(arguments, IntrinsicResolver.FN_IF, num=3)  # type: ignore[no-untyped-call]

        condition_name = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            arguments[0], ignore_errors, parent_function=IntrinsicResolver.FN_IF
        )
        verify_intrinsic_type_str(condition_name, IntrinsicResolver.FN_IF)  # type: ignore[no-untyped-call]

        value_if_true = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            arguments[1], ignore_errors, parent_function=IntrinsicResolver.FN_IF
        )
        value_if_false = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            arguments[2], ignore_errors, parent_function=IntrinsicResolver.FN_IF
        )

        condition = self._conditions.get(condition_name)  # type: ignore[union-attr]
        verify_intrinsic_type_dict(  # type: ignore[no-untyped-call]
            condition,
        ...
        condition_evaluated = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            condition, ignore_errors, parent_function=IntrinsicResolver.FN_IF
        )
        verify_intrinsic_type_bool(  # type: ignore[no-untyped-call]
            condition_evaluated,
            IntrinsicResolver.FN_IF,
    ...
    def handle_fn_equals(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        ...
        verify_intrinsic_type_list(arguments, IntrinsicResolver.FN_EQUALS)  # type: ignore[no-untyped-call]
        verify_number_arguments(arguments, IntrinsicResolver.FN_EQUALS, num=2)  # type: ignore[no-untyped-call]

        value_1 = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            arguments[0], ignore_errors, parent_function=IntrinsicResolver.FN_EQUALS
        )
        value_2 = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
            arguments[1], ignore_errors, parent_function=IntrinsicResolver.FN_EQUALS
        )
        return value_1 == value_2

    def handle_fn_not(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        {"Fn::Not": [{condition}]}
        ...
        verify_intrinsic_type_list(arguments, IntrinsicResolver.FN_NOT)  # type: ignore[no-untyped-call]
        verify_number_arguments(arguments, IntrinsicResolver.FN_NOT, num=1)  # type: ignore[no-untyped-call]
        argument_sanitised = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
        ...
        if isinstance(argument_sanitised, dict) and "Condition" in arguments[0]:
            ...
            verify_intrinsic_type_str(condition_name, IntrinsicResolver.FN_NOT)  # type: ignore[no-untyped-call]

            condition = self._conditions.get(condition_name)  # type: ignore[union-attr]
            verify_non_null(condition, IntrinsicResolver.FN_NOT, position_in_list="first")  # type: ignore[no-untyped-call]
    ...
    @staticmethod
    def get_prefix_position_in_list(i):  # type: ignore[no-untyped-def]
        """
    ...
    def handle_fn_and(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        {"Fn::And": [{condition}, {...}]}
        ...
        verify_intrinsic_type_list(arguments, IntrinsicResolver.FN_AND)  # type: ignore[no-untyped-call]

        for i, argument in enumerate(arguments):
            if isinstance(argument, dict) and "Condition" in argument:
                condition_name = argument.get("Condition")
                verify_intrinsic_type_str(condition_name, IntrinsicResolver.FN_AND)  # type: ignore[no-untyped-call]

                condition = self._conditions.get(condition_name)  # type: ignore[union-attr]
                verify_non_null(  # type: ignore[no-untyped-call]
                    condition, IntrinsicResolver.FN_AND, position_in_list=self.get_prefix_position_in_list(i)  # type: ignore[no-untyped-call]
                )

                condition_evaluated = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
                    condition, ignore_errors, parent_function=IntrinsicResolver.FN_AND
                )
                verify_intrinsic_type_bool(condition_evaluated, IntrinsicResolver.FN_AND)  # type: ignore[no-untyped-call]

                if not condition_evaluated:
                    return False
            else:
                condition = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
                    argument, ignore_errors, parent_function=IntrinsicResolver.FN_AND
                )
                verify_intrinsic_type_bool(condition, IntrinsicResolver.FN_AND)  # type: ignore[no-untyped-call]
    ...
    def handle_fn_or(self, intrinsic_value, ignore_errors):  # type: ignore[no-untyped-def]
        """
        {"Fn::Or": [{condition}, {...}]}
        ...
        verify_intrinsic_type_list(arguments, IntrinsicResolver.FN_OR)  # type: ignore[no-untyped-call]
        for i, argument in enumerate(arguments):
            if isinstance(argument, dict) and "Condition" in argument:
                condition_name = argument.get("Condition")
                verify_intrinsic_type_str(condition_name, IntrinsicResolver.FN_OR)  # type: ignore[no-untyped-call]

                condition = self._conditions.get(condition_name)  # type: ignore[union-attr]
                verify_non_null(  # type: ignore[no-untyped-call]
                    condition, IntrinsicResolver.FN_OR, position_in_list=self.get_prefix_position_in_list(i)  # type: ignore[no-untyped-call]
                )

                condition_evaluated = self.intrinsic_property_resolver(  # type: ignore[no-untyped-call]
                    condition, ignore_errors, parent_function=IntrinsicResolver.FN_OR
                )
                verify_intrinsic_type_bool(condition_evaluated, IntrinsicResolver.FN_OR)  # type: ignore[no-untyped-call]
                ...
                verify_intrinsic_type_bool(condition, IntrinsicResolver.FN_OR)  # type: ignore[no-untyped-call]
                if condition:
                    return True
        return False
