...
def construct_cli_display_message_for_schemas(page_to_render, last_page_number=None):  # type: ignore[no-untyped-def]
...
def construct_cli_display_message_for_registries(page_to_render, last_page_number=None):  # type: ignore[no-untyped-def]
    if last_page_number is None:
        last_page_number = "many"
